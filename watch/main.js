...
function selectBrand() {
  ...
  if (selectedBrand) {
      const products = watches[selectedBrand];
...
function selectProduct() {
  ...
  productMessage.textContent = selectedProduct ? "" : "Please select a valid product.";
}
...
function searchProduct() {
  ...
  if (selectedBrand && selectedProduct) {
      const product = watches[selectedBrand][selectedProduct];
      
      document.getElementById("productName").textContent = product.fullName;
